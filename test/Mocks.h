...
public:
  ...
  MOCK_METHOD3(sendRequest, eipScanner::cip::MessageRouterResponse(
  ...
  MOCK_CONST_METHOD5(sendRequest,
...
public:
  ...
  MOCK_CONST_METHOD1(sendAndReceive,
                     eipScanner::eip::EncapsPacket(
                         const eipScanner::eip::EncapsPacket &packet));
